<x-layout>
    ...
    <x-slot name="head">
        ...
        <meta property="og:description" content="{{ $product->overview ?? $product->description ?? 'Check out this amazing product!' }}">
        ...
        <meta name="twitter:description" content="{{ $product->overview ?? $product->description ?? 'Check out this amazing product!' }}">
        @if($product->images_url && count($product->images_url) > 0)
            <meta name="twitter:image" content="{{ $product->images_url[0] }}">
        @endif
        ...
        <script type="application/ld+json">
        {
            ...
            "category": "{{ $product->category->name }}"@endif
        }
        </script>
    </x-slot>
